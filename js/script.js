...
function atualizaInterface() {
  ...
  if (candidato.length > 0) {
    ...
    seuVotoPara.style.display = "block";
    aviso.style.display = "block";
    descricao.innerHTML = `<div class="aviso-grnade pisca">NÚMERO INVALIDO</div>`
  }
}
...
function branco() {
  ...
  aviso.style.display = "block";
  numeros.innerHTML = "";
  descricao.innerHTML = `<div class="aviso-grnade pisca">VOTO EM BRANCO</div>`;
  lateral.innerHTML = "";
  sizeOfThings()
